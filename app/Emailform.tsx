...
//                     <div className='w-[90px] h-[49px] flex flex-col gap-[10px] items-center justify-center  '>
//                         <div className='h-[20px] aspect-square rounded-full bg-[#00C5FF] text-center text-sm text-white '>2</div>
//                         <div className='text-center text-[12px] text-[#52525B]'>Contact info</div>
//                     </div>
...
//                         <div >
//                             <div className='text-[14px] font-[500] flex'>Email</div>
//                             <input className='bg-[#FAFAFA] text-[14px] border border-[#A1A1AA] rounded-[8px] p-[10px]  w-[360px] h-[44px]' placeholder='name@domain.com' type="email" name="Email" value={form.Email} onChange={handleChange} />
//                         </div>

//                         <div >
//                             <div className='text-[14px] font-[500] flex'>Phone Number</div>
//                             <input className='bg-[#FAFAFA] text-[14px] border border-[#A1A1AA] rounded-[8px] p-[10px]  w-[360px] h-[44px]' placeholder='(+XX)99999999' type="number" name="Phone_Number" value={form.Phone_Number} onChange={handleChange} />
//                         </div>

//                         <button className='col-span-2 rounded-[40px] w-[360px] h-[44px] bg-[#2C7BDE] text-center text-white' type='submit'>
//                             Continue
//                         </button>
//                     </div>
